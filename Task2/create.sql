...
ALTER TABLE
    instructor_taught_instruments
ADD
    CONSTRAINT PK_instructor_taught_instruments PRIMARY KEY (instructor_id);
...
ALTER TABLE
    sibling_id
ADD
    CONSTRAINT PK_sibling_id PRIMARY KEY (sibling_id);
...
ADD
    CONSTRAINT PK_student_phone_number PRIMARY KEY (student_id);
...
ADD
    CONSTRAINT PK_contact_person_email PRIMARY KEY (student_id);
...
ALTER TABLE
    contact_person_name
ADD
    CONSTRAINT PK_contact_person_name PRIMARY KEY (student_id);
...
ALTER TABLE
    instructor
ADD
    CONSTRAINT FK_instructor_0 FOREIGN KEY (lesson_id) REFERENCES lesson (lesson_id);

ALTER TABLE
    instructor_taught_instruments
ADD
    CONSTRAINT FK_instructor_taught_instruments_0 FOREIGN KEY (instructor_id) REFERENCES instructor (instructor_id);
...
ALTER TABLE
    lesson
ADD
    CONSTRAINT FK_lesson_1 FOREIGN KEY (student_id) REFERENCES student (student_id);
...
ALTER TABLE
    sibling_id
ADD
    CONSTRAINT FK_sibling_id_0 FOREIGN KEY (student_id) REFERENCES student (student_id);

ALTER TABLE
    student
ADD
    CONSTRAINT FK_student_0 FOREIGN KEY (sibling_id) REFERENCES sibling_id (sibling_id);

ALTER TABLE
    student_email
ADD
    CONSTRAINT FK_student_email_0 FOREIGN KEY (student_id) REFERENCES student (student_id);

ALTER TABLE
    student_phone_number
ADD
    CONSTRAINT FK_student_phone_number_0 FOREIGN KEY (student_id) REFERENCES student (student_id);

ALTER TABLE
    contact_person_email
ADD
    CONSTRAINT FK_contact_person_email_0 FOREIGN KEY (student_id) REFERENCES student (student_id);

ALTER TABLE
    contact_person_name
ADD
    CONSTRAINT FK_contact_person_name_0 FOREIGN KEY (student_id) REFERENCES student (student_id);

ALTER TABLE
    ensemble_lesson
ADD
    CONSTRAINT FK_ensemble_lesson_0 FOREIGN KEY (lesson_id) REFERENCES lesson (lesson_id);

ALTER TABLE
    group_lesson
ADD
    CONSTRAINT FK_group_lesson_0 FOREIGN KEY (lesson_id) REFERENCES lesson (lesson_id);

ALTER TABLE
    individual_lesson
ADD
    CONSTRAINT FK_individual_lesson_0 FOREIGN KEY (lesson_id) REFERENCES lesson (lesson_id);